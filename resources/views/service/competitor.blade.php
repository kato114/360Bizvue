          ...
          <div class="col-lg-12 ftco-animate">
            <div class="row">
              <div class="col-md-5 col-sm=12">
                <img src="{{ asset('public/assets/images/competitor1.png')}}" alt="" class="img-fluid service-img">
              </div>
        ...
        <div class="row no-gutters pb-5">
          <div class="col-md-12">
            <div class="services-wrap d-flex">
              <div class="img order-md-last" style="background-image: url({{ asset('public/assets/images/services-1.jpg')}});"></div>
              <div class="text">
          ...
          <div class="col-md-12">
            <div class="services-wrap d-flex">
              <div class="img" style="background-image: url({{ asset('public/assets/images/services-2.jpg')}});"></div>
              <div class="text">
          ...
          <div class="col-md-12">
            <div class="services-wrap d-flex">
              <div class="img order-md-last" style="background-image: url({{ asset('public/assets/images/services-3.jpg')}});"></div>
              <div class="text">
          ...
          <div class="col-md-12">
            <div class="services-wrap d-flex">
              <div class="img" style="background-image: url({{ asset('public/assets/images/services-4.jpg')}});"></div>
              <div class="text">
          ...
          <div class="col-md-12">
            <div class="services-wrap d-flex">
              <div class="img order-md-last" style="background-image: url({{ asset('public/assets/images/services-5.jpg')}});"></div>
              <div class="text">
          ...
          <div class="col-md-12">
            <div class="services-wrap d-flex">
              <div class="img" style="background-image: url({{ asset('public/assets/images/services-6.jpg')}});"></div>
              <div class="text">
          ...
          <div class="col-md-12">
            <div class="services-wrap d-flex">
              <div class="img order-md-last" style="background-image: url({{ asset('public/assets/images/services-7.jpg')}});"></div>
              <div class="text">
